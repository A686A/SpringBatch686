...
import com.example.springbootdemo.listener.CsvToDBJobListener;
...
public class CsvToDBJobConfig {
    ...
    public MyBatisBatchItemWriter<Employee> cvsToDBItemWriter() {
        ...
        itemWriter.setStatementId("com.example.springbootdemo.mapper.BatchMapper.saveTemp");  //操作sql
        return itemWriter;
    }
    ...
    public Job csvToDBJob() {
        return jobBuilderFactory.get("csvToDB-step-job")
                ...
                .listener(csvToDBJobListener())//设置状态监听器
                .build();
    }
}